...
export default async function handler(req,res){
  ...
  try{
    ...
    if(type==='display-settings'){
      ...
      const update={id:1,display_mode:allowedModes.includes(body.display_mode)?body.display_mode:'cycle',logo_duration_ms:intInRange(body.logo_duration_ms,3200),leaderboard_duration_ms:intInRange(body.leaderboard_duration_ms,12000),map_duration_ms:intInRange(body.map_duration_ms,9000),announcement_duration_ms:intInRange(body.announcement_duration_ms,9000),live_game_booth_1_enabled:body.live_game_booth_1_enabled!==false,live_trial_booth_1_enabled:body.live_trial_booth_1_enabled!==false,live_game_booth_2_enabled:body.live_game_booth_2_enabled!==false,live_trial_booth_2_enabled:body.live_trial_booth_2_enabled!==false,show_live_sync_status:body.show_live_sync_status===true,updated_at:new Date().toISOString()};
